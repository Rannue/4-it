...
"
        ...
        <StickyHeadingListSection
          ...
          items={[
            ...
            { text: 'поставка оборудования с гарантией и необходимыми сертификатами' },
            { text: 'установка, настройка и ввод в эксплуатацию' },
            { text: 'техническая поддержка и сервисное обслуживание' },
          ]}
        />
